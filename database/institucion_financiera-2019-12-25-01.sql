...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-12-2019 a las 00:36:37
...
CREATE TABLE `politica` (
  `id` int(11) NOT NULL,
  `tasaMora` decimal(2,0) NOT NULL,
  `diasIncobrabilidad` int(11) NOT NULL,
  `montoInicial` decimal(2,0) NOT NULL,
  `montoFinal` decimal(2,0) NOT NULL,
  `diasCobro` int(11) NOT NULL,
  `tasaInteres` decimal(2,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
