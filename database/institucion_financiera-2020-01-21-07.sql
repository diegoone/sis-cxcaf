...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-01-2020 a las 16:37:18
...
INSERT INTO `activo_fijo` (`id`, `nombre`, `descripcion`, `procedencia`, `precio`, `idDepartamento`, `idTipo`, `idMarca`, `idSucursal`, `fechaAdquisicion`) VALUES
(1, 'Terreno', 'Terreno en Apastepeque 5 manzanas', 'NUEVO', '250000.00', 1, 1, 1, 1, '2020-01-04');
...
INSERT INTO `credito` (`id`, `monto`, `fecha`, `cobro`, `idPolitica`, `estado`, `idCliente`, `tipoCredito`) VALUES
(1, '2000.00', '2020-01-04', '200.00', 2, 'cancelado', 17, 'PERSONAL');
...
INSERT INTO `cuota` (`id`, `fecha`, `enMora`, `estado`, `idCredito`) VALUES
(1, '2020-01-04', 0, 'pendiente', 1);
